...
<?= $this->section('back'); ?>
<a href="<?= base_url(); ?>" class="btn btn-lg btn-outline-light bg-primary text-white fw-bold shadow-sm m-4 position-absolute" style="z-index: 1050; border-radius: 10px;">
