...
<!-- ====== RINGKASAN DASHBOARD ====== -->
<div class="row g-3"><!-- g-3 = jarak antar kartu -->
...
<!-- ANGGOTA -->
<div class="col-6 col-lg-6"><!-- ⇠ ubah col-lg-3 → col-lg-6 -->
...
<!-- LOANS -->
<div class="col-6 col-lg-6"><!-- ⇠ ubah col-lg-9 → col-lg-6 -->
      ...
      <div class="card-body">
        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
          <div class="mb-3 mb-sm-0">
            <h5 class="card-title fw-semibold">Grafik 7 hari terakhir</h5>
          </div>
        </div>
        <div id="chart"></div>
      </div>
